            ...
            <div className="relative px-4 pt-16 pb-8 lg:pb-18 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32">
              ...
              <div className="max-w-sm mx-auto mt-10 sm:flex sm:max-w-none sm:justify-center">
                {user ? (
                  <Link
                    to="/notes"
                    className="flex items-center justify-center px-4 py-3 text-base font-medium bg-white border border-transparent rounded-md shadow-sm text-sky-700 hover:bg-sky-50 sm:px-8"
                  >
                  ...
                  <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                    ...
                    <Link
                      to="/login"
                      className="flex items-center justify-center px-4 py-3 font-medium text-white rounded-md bg-sky-500 hover:bg-sky-600 "
                    >
                      Log In
                    </Link>
                  </div>
